<div class="modal fade" id="auxiliarSemana" tabindex="-1" role="dialog" aria-labelledby="auxiliarEmpeno" aria-hidden="true" >
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title text-white" id="auxiliarSemana">Reporte de ventas Semana</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body" >
        <form  action="{{route('reporteSemana')}}" method="GET" target="_black">
